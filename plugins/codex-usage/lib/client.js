  ...
  factory: (require) => {
    ...
    function UsagePanel({ usage, loading, error, onRefresh, onClose }) {
      ...
      return React.createElement(
        ...
        React.createElement(
          "div",
          { style: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10, paddingBottom: 10, borderBottom: `1px solid ${colors.border}` } },
          React.createElement(
            "div",
        ...
        usage?.planType
          ? React.createElement(
              "div",
              { style: { display: "flex", alignItems: "center", gap: 7, padding: "9px 0 8px", color: colors.secondary, fontSize: 12 } },
        ...
        windows.map((item, index) => {
          ...
          return React.createElement(
            "div",
            { key: `${item.label}-${index}`, style: { padding: index === 0 ? "2px 0 10px" : "10px 0", borderTop: index === 0 ? 0 : `1px solid ${colors.border}` } },
            React.createElement(
              "div",
        ...
        React.createElement(
          "div",
          { style: { display: "flex", justifyContent: "flex-end", paddingTop: 9, borderTop: windows.length ? `1px solid ${colors.border}` : 0 } },
          React.createElement(
            "button",
